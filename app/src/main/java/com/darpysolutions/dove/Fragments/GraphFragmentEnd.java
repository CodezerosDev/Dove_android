...
public class GraphFragmentEnd extends Fragment implements
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View mainView = inflater.inflate(R.layout.fragment_graph_end, null);
        ...
        btnContinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                getActivity().startActivity(new Intent(getActivity(), PlanDashBoard.class).putExtra(Constants.BUY_FLAG, false));
                getActivity().finish();
            }
        });
