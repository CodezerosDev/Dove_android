...
public class HistorySalePlansAdapter extends RecyclerView.Adapter<HistorySalePlansAdapter.MyViewHolder> {
    Context mContext;
    ArrayList<String> drBeanArrayList;

    public HistorySalePlansAdapter(Context context, ArrayList<String> doctorBeanArrayList) {
        mContext = context;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.raw_salehistory, parent, false);
