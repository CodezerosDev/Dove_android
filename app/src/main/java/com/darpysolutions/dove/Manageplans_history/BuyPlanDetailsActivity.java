...
public class BuyPlanDetailsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buyplandetails);
    ...
    private void showConfirmDelete() {
        ...
        final Dialog dialog = new Dialog(BuyPlanDetailsActivity.this, R.style.MyDialog2);
