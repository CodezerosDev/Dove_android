...
public class BuyData extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_buydata);
    ...
    public void SalePurchaseActivity(View view) {
        ...
        try {
            ...
            if (mode == AppOpsManager.MODE_ALLOWED) {
                startActivity(new Intent(this, PlanDashBoardOngoingPlan.class).putExtra(Constants.BUY_FLAG, true));
                finish();
            } else {
