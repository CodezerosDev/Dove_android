...
import com.darpysolutions.dove.Fragments.BuyFragment;
import com.darpysolutions.dove.Fragments.SellFragment;
...
public class PlanDashBoard extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plandashboard);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tvBuyData:
                ...
                replaceFragment(R.id.flParentLayout, new BuyFragment(), false);
                break;
            case R.id.tvSaleData:
                ...
                replaceFragment(R.id.flParentLayout, new SellFragment(), false);
                break;
            case R.id.tvWallet:
    ...
    public void showGraphFragment(String s, String generated) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            args.putLong("lastKnowData", getNetworkStatsAll(networkStatsHelper, PlanDashBoard.this));
        } else
    ...
    public void ListAvailablePlans() {
        Intent myIntent = new Intent(PlanDashBoard.this, ListWifiActivity.class);
    ...
    public void saleData(String generated, String vol) {
        WifiUtils wifiUtils = new WifiUtils(PlanDashBoard.this);
