 ...
 */
public class EditText_poppins_bold extends android.support.v7.widget.AppCompatEditText {


    public EditText_poppins_bold(Context context) {
        super(context);
        this.setTypeface(Typeface.createFromAsset(context.getAssets(), "fonts/poppins_bold.ttf"));
    }

    public EditText_poppins_bold(Context context, AttributeSet attrs) {
        super(context, attrs);
