 ...
 */
public class EditText_poppins_extralight extends android.support.v7.widget.AppCompatEditText {


    public EditText_poppins_extralight(Context context) {
        super(context);
        this.setTypeface(Typeface.createFromAsset(context.getAssets(), "fonts/poppins_extralight.ttf"));
    }

    public EditText_poppins_extralight(Context context, AttributeSet attrs) {
        super(context, attrs);
