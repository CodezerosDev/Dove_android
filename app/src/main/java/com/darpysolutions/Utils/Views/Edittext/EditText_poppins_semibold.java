 ...
 */
public class EditText_poppins_semibold extends android.support.v7.widget.AppCompatEditText {


    public EditText_poppins_semibold(Context context) {
        super(context);
        this.setTypeface(Typeface.createFromAsset(context.getAssets(), "fonts/poppins_semibold.ttf"));
    }

    public EditText_poppins_semibold(Context context, AttributeSet attrs) {
        super(context, attrs);
