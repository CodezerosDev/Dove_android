 ...
 */
public class EditText_poppins_extrabold extends android.support.v7.widget.AppCompatEditText {


    public EditText_poppins_extrabold(Context context) {
        super(context);
        this.setTypeface(Typeface.createFromAsset(context.getAssets(), "fonts/poppins_extrabold.ttf"));
    }

    public EditText_poppins_extrabold(Context context, AttributeSet attrs) {
        super(context, attrs);
