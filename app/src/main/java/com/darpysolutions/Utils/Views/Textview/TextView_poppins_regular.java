 ...
 */
public class TextView_poppins_regular extends android.support.v7.widget.AppCompatTextView {

    public TextView_poppins_regular(Context context) {
        super(context);
        this.setTypeface(Typeface.createFromAsset(context.getAssets(), "fonts/poppins_regular.ttf"));
    }
