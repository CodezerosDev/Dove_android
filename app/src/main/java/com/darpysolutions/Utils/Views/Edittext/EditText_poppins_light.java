 ...
 */
public class EditText_poppins_light extends android.support.v7.widget.AppCompatEditText {


    public EditText_poppins_light(Context context) {
        super(context);
        this.setTypeface(Typeface.createFromAsset(context.getAssets(), "fonts/poppins_light.ttf"));
    }

    public EditText_poppins_light(Context context, AttributeSet attrs) {
        super(context, attrs);
